...
export const PARTY_PACKAGES: Package[] = [
  { name: 'Package 1', price: '$350', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['3-hour party', 'Gym and Multipurpose Room', 'Large inflatable', 'Gaming Zone', '20 roller coaster VR experiences', 'Up to 75 guests', 'Includes 1 hour setup and 30 minute clean-up period'] },
  { name: 'Package 2', price: '$350', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['3-hour party', 'Gym and Multipurpose Room', 'Large inflatable', 'Small inflatable', 'Up to 125 guests', 'Includes 1 hour setup and 30 minute clean-up period'] },
  { name: 'Package 3', price: '$250', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['3-hour party', 'Dining Hall', 'Gaming Zone', '20 roller coaster VR experiences', 'Up to 100 guests', 'Includes 1 hour setup and 30 minute clean-up period'] },
  { name: 'Package 4', price: '$300', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['3-hour party', 'Dining Hall', 'Gaming Zone', 'MultiBall Zone', 'Up to 100 guests', 'Includes 1 hour setup and 30 minute clean-up period'] },
  { name: 'Package 5', price: '$200', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['2-hour party', 'Arcade Party Room', '25 photo booth prints', 'Game led by party host', 'Up to 40 guests', 'Includes 30 minute setup and 30 minute clean-up period'] },
  { name: 'Package 6', price: '$225', photo: '/photos/events/party-package.webp', photoAlt: 'Party Package: blue, gold, and white balloons with confetti', items: ['2-hour party', 'Arcade Party Room', '25 photo booth prints', 'Up to 40 guests', 'Includes 30 minute setup and 30 minute clean-up period'] },
]
