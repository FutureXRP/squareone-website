...
export default async function EventsPage() {
  ...
  return (
    <>
      <PageBanner src="/photos/events/banner.webp" alt="SquareOne Events: a graduation party in the Gym/Multipurpose Room with guests at decorated tables. Parties, showers, celebrations." priority full width={1600} height={800} />
      <PageIntro title="Host it at SquareOne.">
        <p className="text-ink">
          Our gym, party rooms, and event spaces host birthday parties, showers, indoor practices, meetings, weddings, and fundraisers. Book online with live availability, or start with a party package.
        </p>
      </PageIntro>
