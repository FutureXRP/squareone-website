...
export default async function InteractivePage() {
  ...
  return (
    <>
      <PageBanner src="/photos/interactive/banner.webp" alt="Three views of SquareOne Interactive: the MultiSport simulator showing hunting, hoops, cornhole, and QB games, the Party Arcade Zone with arcade cabinets, and the Gaming Zone with simulator seats and gaming stations" priority full width={1600} height={646} />
